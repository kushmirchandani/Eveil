...
#ifndef EVEIL_SWIFT_H
#define EVEIL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Eveil",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Eveil10BLEManager")
...
@class NSNumber;
@interface BLEManager (SWIFT_EXTENSION(Eveil)) <CBPeripheralDelegate>
...
@class NSString;
@interface BLEManager (SWIFT_EXTENSION(Eveil)) <CBCentralManagerDelegate>
